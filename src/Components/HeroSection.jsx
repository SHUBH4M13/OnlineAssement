...
import MacbookProcess from './HomePage/MacbookProcess'
import NumbersHome from './HomePage/NumbersHome'
import Features from './HomePage/HomeFeatures/Features'

export default function HeroSection() {
  return (
    <div>
      <div className=' bg-[#141414] py-24 px-12 flex justify-evenly gap-10'>
