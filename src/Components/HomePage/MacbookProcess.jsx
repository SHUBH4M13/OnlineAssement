...
import Option from '../QuestionSection/Option'
import { ClockIcon } from '@heroicons/react/24/outline'

export default function MacbookProcess () {
  return (
    <div className=' w-[612px] h-[512px] rounded-xl bg-[#232323] border-[#333333] border shadow-2xl'>
        ...
        <div className=' w-full h-8/10 py-6 px-7 '>
            <div className=' w-full h-[360px] mb-10 bg-[#2a2a2a] rounded-xl'>
                <div className=' px-3 py-4 w-full h-[50px] flex justify-between'>
                    <p className=' px-2 font-Helvetica font-medium text-[#6366f1]'>Question 7/30</p>
                    <div className=' mr-2 w-[79px] h-[28px] bg-[#6366f1] rounded-2xl flex justify-center items-center gap-1.5'>
        ...
        <div className=' flex justify-between px-10'>
            <button  className=' h-[35px] w-[85px] bg-[#6366f1] rounded-lg font-Helvetica font-small text-white hover:bg-[#4f46e5] duration-300'> Previous </button>
            <button className=' h-[35px] w-[65px] bg-[#6366f1] rounded-lg font-Helvetica font-small text-white  hover:bg-[#4f46e5] duration-300 '> Next </button>
        </div>
