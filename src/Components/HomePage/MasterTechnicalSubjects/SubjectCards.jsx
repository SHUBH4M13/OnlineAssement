...
export default function SubjectCards({ Subject, features, icon: Icon }) {
    return (
        <div className="h-[21rem] w-[23rem] flex flex-col justify-evenly px-4 py-6 bg-[#1e1e1e] hover:bg-[#4040405e] rounded-xl transition duration-300">

            <div className="flex items-center gap-3">
                <div className="h-12 w-12 bg-[#6365f171] rounded-lg flex justify-center items-center">
                        <Icon className="size-8 text-[#6365f1]"/>  {/* fix this shit*/}
                </div>
